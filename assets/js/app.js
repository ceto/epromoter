...
jquery__WEBPACK_IMPORTED_MODULE_0___default()("#contactform").on("submit", function (ev, frm) {
  ev.preventDefault(); //alert("elcsipve");
  //get input field values

  var user_name = jquery__WEBPACK_IMPORTED_MODULE_0___default()("input[name=name]").val();
  var user_email = jquery__WEBPACK_IMPORTED_MODULE_0___default()("input[name=email]").val();
  var user_tel = jquery__WEBPACK_IMPORTED_MODULE_0___default()("input[name=tel]").val();
  var user_msg = jquery__WEBPACK_IMPORTED_MODULE_0___default()("textarea[name=text]").val();
  var proceed = true;
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("input:checkbox[name=acceptgdpr]:checked").length < 1) {
    proceed = false;
  ...
  if (proceed) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#contact_submit").addClass("disabled");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#contact_submit").attr("disabled", "disabled");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#contact_submit").text("Küldés folyamatban"); //Ajax post data to server

    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#contactform").attr("action"), post_data, function (response) {
      var output = ""; //load json data from server and output message

      if (response.type === "error") {
        output = '<p class="error">' + response.text + "</p>";
      } else {
        output = '<p class="success">' + response.text + "</p>"; //reset values in all input fields

        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#contactform input").val("");
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#contactform textarea").val("");
      }

      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#result").hide().html(output).slideDown();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#contact_submit").removeClass("disabled");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#contact_submit").removeAttr("disabled");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#contact_submit").text("Visszahívást kérek!");
    }, "json");
  }
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()("#contactform input, #contactform textarea, #contactform #accept").keyup(function () {
  //$("#contactform input, #contactform textarea").css('border-color', '');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#result").slideUp();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#formerror").slideUp();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()("#contactform #accept").on("change", function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#result").slideUp();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#formerror").slideUp();
});
...
module.exports = __webpack_require__(/*! /Users/ceto/Htdocs/apps/epromoter/src/assets/js/app.js */"./src/assets/js/app.js");
